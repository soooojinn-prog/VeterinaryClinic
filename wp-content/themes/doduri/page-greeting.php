...
.greeting-rule { width:40px; height:2px; background:var(--primary); margin:26px 0 28px; }
.greeting-body { font-size:15px; line-height:2; color:#5a5149; }
.greeting-body p + p { margin-top:16px; }
.greeting-body strong { color:var(--dark); font-weight:700; }
